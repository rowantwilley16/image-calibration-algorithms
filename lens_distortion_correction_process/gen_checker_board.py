...
save_file_name = "4000x4000_checkerboard.jpg"
...
def generate_checkerboard(width, height, square_size):
    ...
    img.save(fr"C:\Users\rowan\OneDrive\Desktop\code\image-calibration-algorithms\lens_distortion_correction_process\input_images\{save_file_name}")
    return img

if __name__ == "__main__":
    width = 4000
    height = 4000
    square_size = 400 # Adjust the square size as needed
